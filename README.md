...
- [ ] Add mouse joint / spring (drag bodies with cursor)
- [ ] Broadphase: spatial grid or AABB tree for O(n log n) collision
- [ ] Constraints: distance joint, hinge/revolute joint
- [ ] Sleeping bodies (skip integration for resting objects)
- [ ] Debug overlay: velocity vectors, contact normals
- [ ] Scene serialization (save/load JSON)
- [ ] Switch to modern OpenGL (VAO/VBO + shaders) for glow effects
